  ...
  return (
    <SafeAreaView style={tw`flex-1 flex-row justify-center`}>
      ...
      >
        ...
        <View
          style={tw`absolute top-[70px] left-[40px] w-[74px] h-[74px] rounded-[10px]`}
        >
          <MotiView
        ...
        <View
          style={tw`absolute top-[75px] right-[50px] w-[61px] h-[61px] rounded-[10px]`}
        >
          <MotiView
            animate={{ scale: [1, 1.2, 1] }}
            transition={{ type: "timing", duration: 1500, loop: true }}
        ...
        <View
          style={tw`absolute top-[200px] left-[20px] w-[100px] h-[100px] rounded-[10px]`}
        >
          <MotiView
          ...
          >
            <Image
              source={im3}
              style={tw`w-[100px] h-[100px] rounded-[10px]`}
            />
          </MotiView>
        </View>

        <View
          style={tw`absolute top-[220px] right-[40px] w-[74px] h-[74px] rounded-[10px]`}
        >
          <MotiView
            animate={{ scale: [1, 1.2, 1] }}
            transition={{ type: "timing", duration: 1500, loop: true }}
        ...
        >
          <Text
            style={tw`text-white text-[22px] font-bold text-center mt-5 font-roboto`}
          >
            Can't stop singing.
          </Text>
          <Text
            style={tw`text-white text-[17px] text-center mt-5 font-roboto w-[300px]`}
          >
